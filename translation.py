...
URL | filename | username | password"""
    DOWNLOAD_START = "📥Downloading NVS Server..."
    UPLOAD_START = "📤Uploading NVS Server To Telegram..."
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry. But, I cannot upload files greater than 2GB due to Telegram API limitations."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thanks for using @NVSHDMOVIE\n\n<b>Join : @NVSHDMOVIE</b>"
...
If bot didn't respond, contact @annyoing_boy"""
